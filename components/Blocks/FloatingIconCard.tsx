      ...
      {data.idx && !withIcon && (
        <div className="flex flex-col items-center md:items-start">
          <div className="flex flex-col items-center">
            ...
            <div className="relative h-10 w-0.5 bg-black shadow-verticalDashes before:absolute before:left-1/2 before:top-[-0.6rem] before:block before:h-[20px] before:w-[20px] before:-translate-x-1/2 before:rounded-full before:border-2 before:border-secondary-15 before:bg-white" />
          </div>
        </div>
      )}
